                ...
                <?php while ($row = mysqli_fetch_assoc($query)): ?>
                    ...
                    <tr class="border-b border-slate-800 hover:bg-slate-800/50 transition">
                            ...
                            <div class="flex items-center gap-4">
                                ...
                                <div class="relative w-14 h-20 overflow-hidden rounded-lg">
                                    ...
                                    <?php foreach ($listCover as $i => $cover): ?>
                                        ...
                                        <img src="../../assets/img/cover/<?= htmlspecialchars($cover); ?>"
                        ...
                        <td class="px-6 py-4">
                            ...
                            <span class="<?= $statusClass; ?> border px-3 py-1 rounded-full text-xs font-semibold">
...
<script>
    ...
    document.querySelectorAll('[class^="cover-slide-"]').forEach((el) => {
        let className = [...el.classList].find(c => c.startsWith('cover-slide-'));
