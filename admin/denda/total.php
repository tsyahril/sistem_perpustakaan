    ...
    <div class="flex justify-between items-center mb-6 flex-wrap gap-4">
        ...
        <div>
            ...
            <p class="text-slate-400 mt-1">
                Management data denda perpustakaan
            </p>
        </div>
                    ...
                    <?php if ($query && mysqli_num_rows($query) > 0): ?>
                        ...
                        while ($row = mysqli_fetch_assoc($query)):
                            ...
                            if ($current_user != $row['nama']) {
                                ...
                                echo "
                                <tr
                                    class='bg-slate-800/80 hover:bg-slate-700 transition duration-200 cursor-pointer border-b border-slate-700'
                        ...
                        ?>
                            ...
                            <tr class="user-row user<?= $row['id_user']; ?> hidden bg-slate-900/40 hover:bg-slate-800/50 transition duration-200 border-b border-slate-800">
...
$getUserPrint = mysqli_query($conn, "
    SELECT DISTINCT user.id_user, user.nama
    FROM peminjaman
    JOIN user 
        ON peminjaman.id_user = user.id_user
    JOIN buku
